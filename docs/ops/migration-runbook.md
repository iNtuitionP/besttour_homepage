...
# 원격 적용 기록 — 0022 (2026-09-23 · 컨트롤러)

**시험 먼저, 운영 나중**(두 번째 적용). 이 파일은 함수 하나를 더할 뿐 기존 동작·권한을 바꾸지 않아 **적용 창이 없다** — 적용 → 배포 순서만 지킨다.

| | 시험 `gjnieoojgmhulkohdcnl` | 운영 `expexkhcuogkavpacrem` |
|---|---|---|
| 적용 전 이력 | `0021` | `0021` (활성 질의 0 · 잠금 대기 0) |
| 적용 후 이력 | **`0022`** | **`0022`** |
| `admin_stats` 함수 | 1개 | 1개 |
