 ...
 * 위젯 선택지는 LOCATION_CODES(28) 전부 — 공항 / 16개 시도 / 대표 노선 도시 세 그룹, 라벨은 locationLabelKo.
 */
import { getTranslations } from "next-intl/server";

import { LOCATION_CODES, REGIONS, locationLabelKo, type LocationCode } from "@/lib/codes";
...
export async function Hero() {
  ...
  const option = (code: LocationCode) => ({ value: code, label: locationLabelKo(code) });
